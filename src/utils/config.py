...
def process_config(json_file):
    ...
    if config.run_on_cluster:
        config.project_directory = "/home/gp104/projects/def-josedolz/gp104/text-person"
        config.summary_dir = os.path.join(config.project_directory, 'experiments',config.exp_name, "summaries/")
        config.checkpoint_dir = os.path.join(config.project_directory, 'experiments',config.exp_name, "checkpoints/")
        config.out_dir = os.path.join(config.project_directory, 'experiments',config.exp_name, "out/")
        config.log_dir = os.path.join(config.project_directory, 'experiments',config.exp_name, "logs/")
        create_dirs([config.summary_dir, config.checkpoint_dir, 'experiments',config.out_dir, config.log_dir])
        config_dest = os.path.join(config.project_directory, 'experiments',config.exp_name, "config.json")
