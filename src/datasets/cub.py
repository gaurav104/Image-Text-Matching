...
class CUBLoader:
	def __init__(self, config):
		...
		if self.config.run_on_cluster:
			...
			anno_dir = os.path.join(output_string, 'CUB/processed_data')
			# root_infer = os.path.join(output_string, 'brats_data/')
		...
		test_set_images = CUB_images('test', 
							self.config.image_dir,
							self.config.anno_dir,
							self.config.max_length,
							transforms=self.input_transform)

		test_set_captions = CUB_captions('test',
							self.config.image_dir,
							self.config.anno_dir,
							self.config.max_length,
							transforms=self.input_transform)
...
if __name__ == '__main__':
	...
	train_set = CUB('train', "/home/gaurav/Desktop/person-id/Datasets/CUB/images","/home/gaurav/Desktop/person-id/Datasets/CUB/processed_data",100,transformations)
