...
class CUHKLoader:
	def __init__(self, config):
		...
		if self.config.run_on_cluster:
			...
			anno_dir = os.path.join(output_string, 'CUHK-PEDES/processed_data')
			# root_infer = os.path.join(output_string, 'brats_data/')
...
if __name__ == '__main__':
	...
	train_set = CUHK_pedes('train', "/home/gaurav/Desktop/person-id/Datasets/CUHK-PEDES/images","/home/gaurav/Desktop/person-id/Datasets/CUHK-PEDES/processed_data",100,transformations)
