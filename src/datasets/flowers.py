...
class FlowersLoader:
	def __init__(self, config):
		...
		if self.config.run_on_cluster:
			...
			anno_dir = os.path.join(output_string, 'Flowers/processed_data')
			# root_infer = os.path.join(output_string, 'brats_data/')
		...
		test_set_images = Flowers_images('test', 
							self.config.image_dir,
							self.config.anno_dir,
							self.config.max_length,
							transforms=self.input_transform)

		test_set_captions = Flowers_captions('test',
							self.config.image_dir,
							self.config.anno_dir,
							self.config.max_length,
							transforms=self.input_transform)
...
if __name__ == '__main__':
	...
	train_set = Flowers('train', "/home/gaurav/Desktop/person-id/Datasets/Flowers/images","/home/gaurav/Desktop/person-id/Datasets/Flowers/processed_data",30,transformations)
