...
class Flickr30kLoaderBert:
	def __init__(self, config):
		...
		if self.config.run_on_cluster:
			...
			anno_dir = os.path.join(output_string, 'Flickr30k/processed_data_bert')
		...
		test_set_image = Flickr30k_images('test', 
							self.config.image_dir,
							self.config.anno_dir,
							self.config.max_length,
							transforms=self.input_transform)

		test_set_caption = Flickr30k_captions('test',
							self.config.image_dir,
							self.config.anno_dir,
							self.config.max_length,
							transforms=self.input_transform)
...
if __name__ == '__main__':
	...
	train_set = Flickr30k('train', "/home/gaurav/Desktop/person-id/Datasets/Flickr30k/images","/home/gaurav/Desktop/person-id/Datasets/Flickr30k/processed_data_bert",50,transformations)
