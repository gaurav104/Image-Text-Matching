...
from utils.metrics import AverageMeter, AverageMeterList, Loss, Loss_Cross_Project,constraints_loss, compute_topk
# from utils.misc import print_cuda_statistics

cudnn.benchmark = True


class JointFeatureCP(BaseAgent):
    ...
    def __init__(self, config):
        ...
        # define loss
        self.loss = Loss_Cross_Project(self.config)
