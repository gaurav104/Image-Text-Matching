...
from graphs.models.model import Model, ModelBert
...
#             print_cuda_statistics()
    ...
    def save_checkpoint(self, file_name="checkpoint.pth.tar", is_best=0):
        ...
        state = {
            ...
            "image_encoder_state_dict": self.model.image_model.conv_layers.state_dict(),
            "text_encoder_state_dict": self.model.bilstm.bilstm.state_dict(),
            "text_embeddings_state_dict": self.model.bilstm.embed.state_dict()
        }
        # Save the state
